function celciusParaFahrenheit(celsius) {
    ...
    return document.getElementById("valorCalcular2").value = fahrenheit;
}

function fahrenheitParaCelsius(fahrenheit) {
    let celsius = (fahrenheit - 32) / 1.8;
    return document.getElementById("valorCalcular2").value = celsius;
}

function celsiusParaKelvin(celsius) {
    let kelvin = celsius + 273.15;
    return document.getElementById("valorCalcular2").value = kelvin;
}
